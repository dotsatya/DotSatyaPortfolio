...
const Footer = () => {
  ...
  return (
    <>
      <footer
        ref={footerRef}
        className="relative h-[110px] sm:h-[162px] md:h-[180px] lg:h-[220px] w-full bg-transparent"
      >
        <div
          ref={footerPanelRef}
          className="fixed bottom-0 left-0 w-full h-[110px] sm:h-[162px] md:h-[180px] lg:h-[220px]  dark:bg-[#F5F5F5] bg-[#080808] rounded-t-3xl will-change-transform"
          style={{
        ...
        >
          ...
          <div className="w-[98%] mx-auto flex flex-col  px-4 py-4 ">
